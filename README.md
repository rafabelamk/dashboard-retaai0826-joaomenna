# Dashboard · RETAI0826 · João Menna
...
2. Nome sugerido: `dashboard-retai0826-joaomenna`
...
git init
git add .
git commit -m "feat: dashboard RETAI0826 João Menna"
git branch -M main
git remote add origin https://github.com/SEU_USUARIO/dashboard-retai0826-joaomenna.git
...
2. Selecione o repositório `dashboard-retai0826-joaomenna`
